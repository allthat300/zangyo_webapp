	...
	<main role="main" class="container-fluid">
		...
		if(isset($_POST['sql'])){
			try{
				...
				header('Location: sql_anything.php', true, 301); //add-employee.phpにリダイレクト
		...
		<form name="form1" method="post" action="sql_anything.php">
			<textarea class="form-control" name="sql" rows="20"></textarea>
